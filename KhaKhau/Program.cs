...
//    options =>
//{
//    options.DefaultAuthenticateScheme = OAuthDefaults.DisplayName; options.DefaultChallengeScheme = OAuthDefaults.DisplayName;
//}
)
                .AddGoogle(options =>
                {
...
//app.UseMiddleware<FakeGoogleAuthMiddleware>();
app.UseRouting();
